...
const TrendBlogCards = ({ item }: any) => {
  ...
  return (
    <>
      <Link
        href={`/blog/${slug}`}
        className="z-10 mx-auto my-4 max-w-[350px]  rounded-xl bg-gradient-to-r from-[#C946FB] via-[#C946FB] to-[#6161FB] p-[1px] hover:bg-gradient-to-l duration-300 hover:scale-105"
      >
        <div>
          <Image
